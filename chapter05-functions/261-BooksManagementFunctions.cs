...
public class BooksManagementFunctions
{
    ...
    public static void AddNewBook(books[] b, ref int count, int SIZE)
    {
        if (count < SIZE)
        {
            do
    ...
    public static void ShowAllBooks(books[] b, int count)
    {
        if (count == 0)
        {
    ...
    public static void SearchBookByTitleAuthor(books[] b, int count)
    {
    ...
    public static void EditBook(books[] b, int count)
    {
    ...
    public static void DeleteBook(books[] b, ref int count)
    {
    ...
    public static void Main()
    {
        ...
        do
        {
            ...
            {
                case "1": // Add new book
                    AddNewBook(b, ref count, SIZE);
                    break;

                case "2": // Show all books
                    ShowAllBooks(b, count);
                    break;

                case "3": // Search book by title or author
                    SearchBookByTitleAuthor(b, count);
                    break;
