// Home accounting (V4: functions + List + Serialization)
...
public class HomeAccounting
{
        ...
        List<ExpensesIncomes> l)
    {
        ...
        Stream outputFile = new FileStream(fileName,
            ...
            FileShare.None);
        formatter.Serialize(outputFile, l);
        outputFile.Close();
    }
    ...
    public static List<ExpensesIncomes> Load(string fileName)
    {
        ...
        Stream inputFile = new FileStream(fileName,
            ...
            FileShare.Read);
        l = (List<ExpensesIncomes>)formatter.Deserialize(inputFile);
        inputFile.Close();
        return l;
    }
    ...
    public static void Main()
    {
        ...
        {
            e = HomeAccounting.Load("accounting.dat");
        }
        ...
        HomeAccounting.Save("accounting.dat", e);
    }
}
